 ...
 * 2019-12-10T08:20:22.772+01:00
 * Generated source version: 3.2.7
 * 
 */
@WebServiceClient(name = "GeoIPService", 
                  wsdlLocation = "file:/C:/szkolenie-java/repo/java-training/soap-sample/src/main/resources/ipservice.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/szkolenie-java/repo/java-training/soap-sample/src/main/resources/ipservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/szkolenie-java/repo/java-training/soap-sample/src/main/resources/ipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
